...
features : [
    {title: 'Webb Bridge', target: 'https://app.webb.tools/'},
...
Create a best in class bridging experience, with built in privacy controls was the task I faced co-leading the design for Webb's cross-chain, zero-knowledge bridge. The main challenge was translating complex transactions into an intuitive, trustworthy and transparent interface, while balancing the significant technical constraints of this emergent protocol.
...
<img src="/v2/trust/render-02-trust.png" alt="render of fixed amount controls" id="last"/>
