    ...
    return(
        ...
        `}>
            ...
            `}>
                ...
                <a>
                <svg width="20" height="24" viewBox="0 60 320 320"><path className="socialnowaba" d="M153.62,301.59c94.34,0,145.94-78.16,145.94-145.94,0-2.22,0-4.43-.15-6.63A104.36,104.36,0,0,0,325,122.47a102.38,102.38,0,0,1-29.46,8.07,51.47,51.47,0,0,0,22.55-28.37,102.79,102.79,0,0,1-32.57,12.45,51.34,51.34,0,0,0-87.41,46.78A145.62,145.62,0,0,1,92.4,107.81a51.33,51.33,0,0,0,15.88,68.47A50.91,50.91,0,0,1,85,169.86c0,.21,0,.43,0,.65a51.31,51.31,0,0,0,41.15,50.28,51.21,51.21,0,0,1-23.16.88,51.35,51.35,0,0,0,47.92,35.62,102.92,102.92,0,0,1-63.7,22A104.41,104.41,0,0,1,75,278.55a145.21,145.21,0,0,0,78.62,23" fill="white"></path></svg>
                </a>
                <a>
                <svg width="18" height="18" viewBox="0 0 26 20" fill="none" xmlns="https://www.w3.org/2000/svg"><path className="socialnow" fillRule="evenodd" clipRule="evenodd" d="M0 18V2.04272L12.8659 11.728L12.9164 11.6367L12.9301 11.6614L25.9927 1.82812C25.9975 1.88477 26 1.94214 26 2V18C26 19.1045 25.1046 20 24 20H2C0.895416 20 0 19.1045 0 18ZM25.0031 0.269287C24.7082 0.0979004 24.3655 0 24 0H2C1.56735 0 1.16678 0.137207 0.839539 0.37085L12.8538 9.41504L25.0031 0.269287Z" fill="#937EEA" fillOpacity="0.78"></path><path className="socialnowaba" fillRule="evenodd" clipRule="evenodd" d="M0 18V2.04272L12.8659 11.728L12.9164 11.6367L12.9301 11.6614L25.9927 1.82812C25.9975 1.88477 26 1.94214 26 2V18C26 19.1045 25.1046 20 24 20H2C0.895416 20 0 19.1045 0 18ZM25.0031 0.269287C24.7082 0.0979004 24.3655 0 24 0H2C1.56735 0 1.16678 0.137207 0.839539 0.37085L12.8538 9.41504L25.0031 0.269287Z" fill="white"></path></svg>
                </a>
            </div>
        </div>
    )
